...
<div class="account-header">
    <div class="account-avatar">
        <img src="../style/images/logo.png" alt="头像">
    </div>
    <div class="account-info">
        <div class="custom-title">Lucy Wisteria</div>
        <p>在这里，把读过的书、学到的课，和路过的人间，一并讲给未来的自己听。</p>
    </div>
    <div class="qr-container">
        <img src="../photo/image-3.jpg" alt="二维码">
        <span>扫码关注我呀</span>
    </div>
</div>
...
<div class="article-card">
    <a href="https://mp.weixin.qq.com/s/RI7IBw2aW_g7QcpgaQnntA" class="card-link">
        <div class="card-image">
            <img src="../style/images/logo.png" alt="cover">
        </div>
        <div class="card-content">
            <p>Lucy Wisteria's Notebook</p>
            <div class="card-footer">
                <span class="card-tag">本人的笔记网站哈，欢迎来参观留言～</span>
                <span class="card-time"><i class="fa-regular fa-clock"></i> 2026-03-06 14:28</span>
            </div>
        </div>
    </a>
</div>
