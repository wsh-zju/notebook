...
??? example "Example"
    **Question:**计算 \(3^{44} \mod 645\)  
    
    **Answer:**
    
    1. **初始设置**：
    
    \(x=1\)，\(\text{power}=3 \mod 645=3\)，指数44的二进制展开为`10101100`

    2. **逐次运算**：  
    
    - \(i=0\)：\(a_0=0\)，\(\text{power}=3^2\mod645=9\)，\(x=1\)  
    - \(i=1\)：\(a_1=0\)，\(\text{power}=9^2\mod645=81\)，\(x=1\)  
    - \(i=2\)：\(a_2=1\)，\(x=1×81\mod645=81\)，\(\text{power}=81^2\mod645=111\)
    - \(i=3\)：\(a_3=0\)，\(\text{power}=111^2\mod645=66\)，\(x=81\)
    - \(i=4\)：\(a_4=0\)，\(\text{power}=66^2\mod645=486\)，\(x=81\)
    - \(i=5\)：\(a_5=0\)，\(\text{power}=486^2\mod645=126\)，\(x=81\)
    - \(i=6\)：\(a_6=0\)，\(\text{power}=126^2\mod645=396\)，\(x=81\)
    - \(i=7\)：\(a_7=1\)，\(x=81×396\mod645=471\)，\(\text{power}=396^2\mod645=81\)
    - \(i=8\)：\(a_8=0\)，\(\text{power}=81^2\mod645=111\)，\(x=471\)
    - \(i=9\)：\(a_9=1\)，\(x=471×111\mod645=36\)  
